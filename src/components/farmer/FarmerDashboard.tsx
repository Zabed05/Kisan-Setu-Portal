...
export const FarmerDashboard: React.FC<FarmerDashboardProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8 font-sans animate-fade-in-up">
      
      {/* 1. Header Welcome Bar */}
      <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all duration-300 hover:shadow-md hover:scale-[1.005]">
